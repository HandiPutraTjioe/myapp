...
const YourComponent = props => {
  ...
  const [option1, setOption1] = useState(defaultOption) // const [maleCheck, setMaleCheck) = useState(true);
  const [femaleCheck, setFemaleCheck] = useState(false);
  const radioHandler = () => {
  //logic goes here
    if(femaleCheck/option2){
  ...
  return( <View>
  <Text>Male:</Text>
  <RadioButton checked={option1/maleCheck} onPress={radioHandler}/>
  <Text>Female:</Text>
