                ...
                <View style={ styles.container }>
                    ...
                    <View style={ styles.form }>
                        ...
                        <View style={ styles.containerInputAccount }> 
                            ...
                            <View style={[ styles.input, this.state.accountNumber.length > 8 && this.state.accountNumber.length < 17 && !isNaN(accountNumber) ? styles.noterror : styles.error  ]}>
                                ...
                                <TextInput 
                                    ...
                                    onChangeText={val => this.onChangeText('accountNumber', val)}>
                            ...
                            <View style={ styles.bottom }>
                                <View style={{alignItems:'center', marginTop: 0 }}>
                                    <TouchableOpacity
                                        ...
                                        onPress={() => this.props.navigation.navigate('NominalTopUpScreen')}
                                        style={[
                                            styles.styleButtonSignin,
                                                { 
                                                    backgroundColor: this.state.accountNumber !== '' ? '#4263D5' : '#4263D550'
                                                }
                                            ]}>
